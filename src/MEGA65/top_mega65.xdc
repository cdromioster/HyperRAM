...
create_generated_clock -name clk_x4     [get_pins i_clk/i_clk_x2/CLKOUT0]
create_generated_clock -name clk_x2     [get_pins i_clk/i_clk_x2/CLKOUT1]
create_generated_clock -name clk_x2_del [get_pins i_clk/i_clk_x2/CLKOUT2]
create_generated_clock -name clk_x1     [get_pins i_clk/i_clk_x2/CLKOUT3]
create_generated_clock -name kbd_clk    [get_pins i_clk_mega65/i_clk_720p_hdmi/CLKOUT0]
create_generated_clock -name pixel_clk  [get_pins i_clk_mega65/i_clk_720p_hdmi/CLKOUT1]
create_generated_clock -name pixel_clk5 [get_pins i_clk_mega65/i_clk_720p_hdmi/CLKOUT2]
...
set_max_delay -from [get_clocks clk_x2] -to   hr_rwds         23
set_max_delay -to   [get_clocks clk_x2] -from hr_rwds         23
